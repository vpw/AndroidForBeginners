...
public class ExploreTypesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        birdType = bundle.getInt(ExploreActivity.EXTRA_BIRD_TYPE);
        ...
        if (birdsRecyclerView != null) {
            ...
            List<BirdInfo> birds = getBirds(birdType);
    ...
    /**
     * Gets the resource Id of the passed image name
     * @param imgName
     * @return Resource Id
     */
    private int getImgResId(String imgName) {
    ...
    private void getBirdsData() {
        ...
        birds[0] = new BirdInfo[]{
                new BirdInfo(getImgResId("flamingo_gr"),"Greater Flamingo","Phoenicopterus roseus",
                ...
                new BirdInfo(getImgResId("flamingo_ls"),"Lesser Flamingo","Phoenicopterus minor",
                        "The lesser flamingo is the smallest species of flamingo, though it is a tall and large bird by most standards. The species can weigh from 1.2 to 2.7 kg (2.6 to 6.0 lb).[3] The standing height is around 80 to 90 cm (31 to 35 in).[4][5] The total length (from beak to tail) and wingspan are in the same range of measurements, from 90 to 105 cm (35 to 41 in).[4][6] Most of the plumage is pinkish white. The clearest difference between this species and the greater flamingo, the only other Old World species of flamingo, is the much more extensive black on the bill. Size is less helpful unless the species are together, since the sexes of each species also differ in height.\n" +
                                "\n" +
        ...
        birds[1] = new BirdInfo[]{
                new BirdInfo(getImgResId("snow_partridge"),"Snow Partridge","Lerwa lerwa",
                "The snow partridge (Lerwa lerwa) is a gamebird in the pheasant family Phasianidae found widely distributed across the high-altitude Himalayan regions of India, Pakistan, Nepal and China. It is the only species within its genus. The species is found in alpine pastures and open hillside above the treeline but not in as bare rocky terrain as the Himalayan snowcock and is not as wary as that species. Males and females look similar in plumage but males have a spur on their tarsus."+
                        ...
                        "\n" +
                        "It measures 38–40 cm in length. Females weigh 450–580 g; males, 550–700 g. Sexes are similar in plumage, female lacks spurs on the tarsus while the male has a blunt spur and sometimes a second incipient spur. Downy chicks have a resemblance to the chicks of the blood pheasant.[7] Chicks are born with the tarsi feathered and the nostril opening is covered by feathers.",
                getImgResId("lc"),"https://en.wikipedia.org/wiki/Snow_partridge",
                        "lerwa_lerwa"),
                new BirdInfo(getImgResId("tibetan_snowcock"),"Tibetan Snowcock","Tetraogallus tibetanus",
                        ...
                        getImgResId("lc"),"https://en.wikipedia.org/wiki/Tibetan_snowcock",
                        "tetraogallus_tibetanus"),
                new BirdInfo(getImgResId("himalayan_snowcock"),"Himalayan Snowcock","Tetraogallus himalayensis",
                ...
                getImgResId("lc"),
                        ...
                        "perdix_hodgsoniae"),
                new BirdInfo(getImgResId("himalayan_quail"),"Himalayan quail","Ophrysia superciliosa",
                ...
                "The red bill and legs of this small dark quail and white spots before and after the eye make it distinctive. The male is dark grey with bleak streaks and a white forehead and supercilium. The female is brownish with dark streaks and greyish brow. Like the male it has a white spot in front of the eye and a larger one behind the eye.[3] It is believed to fly only when flushed at close quarters and was found in coveys of five or six. The habitat was steep hillsides covered by long grass.[4] The genus name is derived from Ophrys which refers the brow.[5]\n" +
                        "\n" +
                        "This quail has long tail coverts and the 10 feathered tail is longer, nearly as long as the wing, than in most quails.[6] The feathers of the forehead and bristly and stiff.[7][8]\n" +
                        "\n" +
                ...
                getImgResId("cr"),
                        ...
                        "perdix_hodgsoniae"),
                new BirdInfo(getImgResId("manipur_bush_quail"),"Manipur bush quail","Perdicula manipurensis",
                ...
                getImgResId("en"),
                        ...
                        "perdix_hodgsoniae"),
                new BirdInfo(getImgResId("western_tragopan"),"Western tragopan","Tragopan melanocephalus",
                ...
                new BirdInfo(getImgResId("himalayan_monal"),"Himalayan Monal","Lophophorus impejanus",
                "The Himalayan monal (Lophophorus impejanus), also known as the Impeyan monal, Impeyan pheasant, is a bird in the pheasant family, Phasianidae. It is the national bird of Nepal, where it is known as Danphe, and state bird of Uttarakhand India, where it is known as Monal. It was also the state bird of Himachal Pradesh, until 2007.[2]\n" +
                        "\n" +
                        "Traditionally, the Himalayan monal has been classified as monophyletic. However, studies have shown that the male Himalayan monal of northwestern India lacks the white rump of other Himalayan monals, and it has more green on the breast, indicating the possibility of a second subspecies.[3]"+
                ...
                getImgResId("lc"),"https://en.wikipedia.org/wiki/Western_tragopan",
                        "lophophorus_impejanus")

        };
        birds[2] = new BirdInfo[]{new BirdInfo(getImgResId("eastern_great_egret"),"Eastern great Egret","Ardea alba modesta",
                ...
                "Measuring 83–103 cm (33–41 in) in length and weighing 0.7–1.2 kg (1.5–2.6 lb), the eastern great egret is a large heron with all-white plumage. Its bill is black in the breeding season and yellow at other times,[2] and its long legs are red or black.[citation needed] The colours of the bare parts of the face change to green during the breeding season.[2] The breeding plumage is also marked by long neck plumes and a green facial area.[1] The eastern great egret can be distinguished from other white egrets and herons in Asia and Australia by its very long neck, one and a half times as long as its own body.",
                getImgResId("lc"),
                "https://en.wikipedia.org/wiki/Eastern_great_egret",
                "ardea_alba_modesta"),
                new BirdInfo(getImgResId("western_reef_heron"),"Western reef Heron","Egretta gularis",
                        ...
                        "egretta_gularis")};
        birds[3] = new BirdInfo[]{new BirdInfo(getImgResId("brahminy_kite"),"Brahminy Kite","Haliastur indus",
                ...
                "https://en.wikipedia.org/wiki/Western_reef_heron",
                "haliastur_indus"),
                new BirdInfo(getImgResId("andaman_serpent_eagle"),"Andaman serpent Eagle","Spilornis elgini",
                        "The Andaman serpent eagle (Spilornis elgini) is a species of bird of prey in the Accipitridae family. It is endemic to Andaman Islands in India\n" +
                                "\n" +
        ...
        birds[4] = new BirdInfo[]{new BirdInfo(getImgResId("rose_ringed_parakeet"),"Rose-ringed Parakeet","Psittacula krameri",
                ...
                "https://en.wikipedia.org/wiki/Andaman_serpent_eagle",
                "psittacula_krameri"),
                new BirdInfo(getImgResId("blossom_headed_parakeet"),"Blossom-headed Parakeet","Psittacula roseata",
        ...
        birds[5] = new BirdInfo[]{new BirdInfo(getImgResId("indian_scops_owl"),"Indian scops Owl","Otus bakkamoena",
                ...
                "otus_bakkamoena"),
                new BirdInfo(getImgResId("indian_eagle_owl"),"Indian eagle Owl","Bubo bengalensis",
                        ...
                        "https://en.wikipedia.org/wiki/Indian_scops_owl",
                        "bubo_bengalensis")};
        birds[6] = new BirdInfo[]{new BirdInfo(getImgResId("common_kingfisher"),"Common Kingfisher","Alcedo atthis",
                ...
                "https://en.wikipedia.org/wiki/Indian_scops_owl",
                "alcedo_atthis"),
                new BirdInfo(getImgResId("oriental_dwarf_kingfisher"),"Oriental dwarf Kingfisher","Ceyx erithaca","",getImgResId("lc"),
                        "https://en.wikipedia.org/wiki/Indian_scops_owl",
                        "ceyx_erithaca")};
    }
    ...
    public List<BirdInfo> getBirds(int birdType) {
        ...
        for(int i=0; i<birds[birdType].length;i++) birdInfoList.add(new BirdInfo(birds[birdType][i]));
